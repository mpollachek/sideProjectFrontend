    ...
    <Container>
      <Row>
        <Col className="text-center lrmargin10">
          <h2>
            Fighting against the establishment, political dynasties and
            billionaire owned media, there is no doubt much will be said about
            us
          </h2>
          <h3 className="bannerusred">
            The truth is that we are mothers, we are fathers,
            <br />
            we are brothers and we are sisters
            <br />
            We are family, we are friends
            <br />
            We are people who simply want to live happy lives
            <br />
            and leave something better for our children
          </h3>
          <h3>
            Each of these are more important than the fact that we are also
            workers
          </h3>
          <h2>
            And if you stand with us, <em>you</em> are one of us
          </h2>
        </Col>
      </Row>
