import { Row, Col, Container, List, Table } from "reactstrap";
...
const Issues = () => {
  return (
    <Container className="full-width">
      ...
      >
        <Col
          className="text-center my-4 lrmargin"
          style={{ textShadow: "0 0 2px rgb(0, 0, 0), 0 0 5px rgb(0, 0, 0)" }}
        >
          <h2>
            On a macro scale, we believe that there are two primary issues that
            must be resolved for our population to be strong and happy again
          </h2>
          <h3>
            First, we must strengthen workers rights and fairly compensate them
            for their labor, thereby reducing wealth and income inequality and
            building a strong economy that works for the majority rather than
            the few
          </h3>
          <h3>
            Second, we must push for a change in government and laws in such a
            way that legislation is not controlled by wealth
          </h3>
        </Col>
      </Row>
      ...
      <Row
        style={{
          backgroundImage: `url(${warehouse1})`,
          backgroundSize: "cover",
        }}
      >
        <Row>
      ...
      >
        <Col className="text-center my-4 lrmargin">
          <h2>
            The charts above detail a major shift in wealth and income between
            the top 1% and bottom 90% of earners. Billionaire owned media want
            us believe this is normal and political leaders pretend to fight for
            our interests while passing bills that only benefit the wealthy
          </h2>
          ...
          <h2>
            Below is a somewhat random selection of top S&P 500 corporations
          </h2>
          <h3>
            Many top companies have CEO compensation over 1,000 times that of
            their workers. At a worker to CEO pay ratio of 1:1,000, a{" "}
            <b>
              worker would need to work for 1,000 years to earn what the CEO
              receives in 1 year
            </b>
            . To put this another way,{" "}
            <em>
              the worker would need to work for 3 years to receive what the CEO
              gets in 1 day
            </em>
          </h3>
          <h3>
            With approximately{" "}
            <em>
              64% of workers living paycheck to paycheck
              <sup>
                <a href="#sources">1</a>
              </sup>
            </em>{" "}
            this hoarding of wealth is creating an inexcusable stress on workers
            and the economy. Many workers lack the ability to seek proper
            medical care or purchase necessaties for their families. Wealth
            inequality is literally killing people and the trendlines show no
            sign of improving.
          </h3>
        </Col>
      </Row>
          ...
          <Table striped bordered size="sm" style={{ width: "100%" }}>
            ...
            <tbody>
              ...
              <tr>
                <td>Data Sources:</td>
                <td>
                  <a href="https://aflcio.org/paywatch/company-pay-ratios">
                    aflcio
                  </a>
                </td>
                <td>
                  <a href="https://tipalti.com/profit-per-second/">tipalti</a>
                </td>
                <td>
                  <a href="http://www.macrotrends.net/">macrotrends</a>
                </td>
              </tr>
            </tbody>
          </Table>
      ...
      >
        <Col className="text-center my-4 lrmargin">
          <h2>
            Many fortune 500 companies make <b>BILLIONS</b> in profits, pay
            little to no taxes
            <sup>
              <a href="#sources">2</a>
            </sup>{" "}
            thanks to a myriad of tax law loopholes and keep their workers in
            poverty with sublivable compensation. Taxpayers are forced to pay
            these workers wages, thereby subsidizing multi-billion dollar
            corporations, through welfare programs such as SNAP benefits
          </h2>
          <h3>
            The massive profits going to shareholders and executives is wealth
            essentially removed from our economy by being stored in long term
            investment accounts or moved offshore. If workers were fairly
            compensated for the profits they produce for their employers, we
            would see higher spending, an increase in the number of small
            businesses in operation and a happier population by removing the
            great stresses of financial insecurity.
          </h3>
        </Col>
      </Row>
      ...
      >
        <Col className="offset-1 col-10 my-5 bgdark">
          <p>
            <sup>1</sup>48 percent of Americans with annual incomes over
            $100,000 live paycheck to paycheck, 9 percentage points higher than
            first reported in June 2021. Corporate Profile. (n.d.). Retrieved
            November 1, 2022, from{" "}
            <a href="https://ir.lendingclub.com/news/news-details/2022/48-Percent-of-Americans-with-Annual-Incomes-over-100000-Live-Paycheck-to-Paycheck-9-percentage-points-higher-than-first-reported-in-June-2021/default.aspx">
              {" "}
          ...
          <p>
            <sup>2</sup>Ross, J., Khattar, R., Hanlon, S., Simpson, E.,
            Rapfogel, N., Spitzer, E., &amp; Truong, T. Q. (2022, April 25).
            These 19 fortune 100 companies paid next to nothing-or nothing at
            all-in taxes in 2021. Center for American Progress. Retrieved
            November 3, 2022, from{" "}
            <a href="https://www.americanprogress.org/article/these-19-fortune-100-companies-paid-next-to-nothing-or-nothing-at-all-in-taxes-in-2021/">
              {" "}
