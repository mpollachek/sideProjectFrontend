                ...
                <Row>
                    <Col xs={{ size: 5, offset: 1 }} className='text-center my-4'>
                        <ul className='list-unstyled'>
                            <li>
                                <Link to='/' className='footericons'><HomeRoundedIcon/>Home</Link>
                            </li>
                            <li>
                            ...
                            <li>
                            <Link to='/Faq' className='footericons'><QuizIcon 
                            />FAQ
                            </Link>
                            </li>
                            <li>
                            <Link to='/Donate' className='footericons'><LocalAtmIcon/>Donate</Link>
                            </li>
                        </ul>
                    </Col>
